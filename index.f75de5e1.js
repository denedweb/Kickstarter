...
document.querySelector(".slider__buttons__button-right").addEventListener("click", ()=>{
    count += 260;
    if (count > 520) count = 0;
    sliderLine.style.left = -count + "px";
    updateCurrentSlider();
});
document.querySelector(".slider__buttons__button-left").addEventListener("click", ()=>{
    count -= 260;
    if (count < 0) count = 520;
    sliderLine.style.left = -count + "px";
    updateCurrentSlider();
});
